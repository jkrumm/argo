...
| Tag              | Belongs to it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Garmin Health`  | daily-metrics, recovery, training-load, fitness-direction, activities, weight-log, skinfold-log, user-profile, and all corresponding `*/summary` and `*/series` endpoints                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `Strength`       | workouts, workout-sets, exercises, gym equipment config (`/gym`), and all `workouts/summary/*` analytics                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `Astro & Marine` | night-photography and surf go/no-go planning — `/astro/window` (deterministic per-night verdict), `/astro/sites` (candidate drive-to sites with their measured sky + terrain), `/astro/light-pollution` + `/astro/skyglow` (Lorenz atlas: zenith brightness, and the direction-resolved dome where the core sits), `/astro/tiles/lp/{year}/{z}/{x}/{y}.png` (the same atlas as a terrarium-encoded raster tile for the map), `/astro/horizon` (per-azimuth terrain skyline for an arbitrary coordinate, from the AWS terrarium DEM — the same ray-march `astro-sites.ts`'s committed `southHorizonDeg` uses, served live), `/astro/visibility` (the deterministic, weather-free annual visibility budget for a place — "is this spot worth the drive at all" rather than "is tonight worth it" — under three progressively honest gates, resolved via a committed site, a live DEM measurement, or flat only), `/marine/window` (per-day surf session verdict over the same engine) and `/marine/spots` |
